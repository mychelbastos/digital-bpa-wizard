-- CORREÇÃO: o TFD GERA BPA-I, então os procedimentos 0803... já estão nas fichas BPA-I.
-- O branch de TFD (tabelas tfd/tfd_linhas) adicionado antes DUPLICAVA a contagem. Volta as
-- funções a lerem só as fichas (BPA-I/RAAS), como os demais relatórios de produção.
