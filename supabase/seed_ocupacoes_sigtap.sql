-- Ocupações (CBO) do SIGTAP — nomes. Fonte: tb_ocupacao.txt da TabelaUnificada
-- DATASUS TUP, competência 202607 (TabelaUnificada_202607_v2607101010.zip).
-- Gerado a partir do arquivo oficial (fixed-width: CO_OCUPACAO 6 + NO_OCUPACAO 150).
insert into public.ocupacoes_sigtap (codigo, nome) values
