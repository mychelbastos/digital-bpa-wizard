...
// Adaptado de Next.js para Vite/TanStack: `next/image` -> <img>. Demais partes fiéis
// ao componente original (21st.dev "modern-animated-sign-in").
  ...
  const validateForm = (event: FormEvent<HTMLFormElement>) => {
    ...
    fields.forEach((field) => {
      ...
      if (field.type === 'password' && value && value.length < 6) {
        currentErrors[field.label] = 'A senha deve ter ao menos 6 caracteres';
      }
    });
        ...
        <>
          ...
          <BoxReveal boxColor='var(--skeleton)' duration={0.3} width='100%'>
            <section className='flex items-center gap-4'>
              ...
              <p className='text-neutral-700 text-sm dark:text-neutral-300'>ou</p>
              <hr className='flex-1 border-1 border-dashed border-neutral-300 dark:border-neutral-700' />
            </section>
          </BoxReveal>
        </>
